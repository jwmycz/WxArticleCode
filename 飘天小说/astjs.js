...
function a7(c) {
    ...
    "source",
    "onerror",
    "/0.5256273528630887:1735643501:v8_6mOysieq4tz9OYUeOjqi7sOri7ajqj3jBzW5sPfo/",
    "/jsd/r/",
    "sort",
    "cFPWv",
    "bigint",
    ...
    "setRequestHeader",
    "removeChild",
    "B0jqXyKNmPEevilQMC-sZ6bhk4d3O1FcoDxR+n7Wgp9Sr2f5TILYVUAwuJaH8t$Gz",
    "replace",
    "tabIndex",
    "Function",
    "contentDocument",
    ...
    "isArray",
    "Set",
    "_cf_chl_opt;YHws6;Whin0;PmhRk7;abyo7;domE8;bOVG4;hephn8;YmvNm3;WXqDk4;aRcx2;GVOAr6;wpvie3;cVGi2;CScbg6;omQod3;VaUI1;XVati2",
    "8044179cODpuX",
    "onreadystatechange",
    "success",
    "omQod3",
...
//导入需要解析树的文件
// let jscode=fs.readFileSync('./jj.js','utf8');
...
//         debugger
//         if(path.node.callee.name==='a7'){
//             // console.log(path);
//             //console.log(path.toString());
//             a1=path.node.arguments[0].value
//             // a2=path.node.arguments[1].value
//             // console.log(a1);
//             jsdata=a7(a1)
//             // console.log(jsdata);
//             path.replaceWith(
...
fs.writeFile('第2步还原.js', code, (err)=>{});

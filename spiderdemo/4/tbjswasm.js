...
// ----------------- 同步初始化 WASM -----------------
function initWasmSync(wasmPath) {
...
// ----------------- getdata -----------------
function getdata(page, timestamp) {
    return encrypt_simple(page, timestamp);
}

// ----------------- 初始化一次 -----------------
initWasmSync(path.resolve('./jm.wasm'));

// ----------------- 测试 -----------------
// const page = 'test_page';
page='wasm_challenge_page_3'
// const timestamp = Date.now().toString();
timestamp='1760497318'
const encrypted = getdata(page, timestamp);
console.log('加密结果:', encrypted==='39d6129e89e5c92e4afc0c516993e35c4dafb91a35505bfc23b506585be92ee8');

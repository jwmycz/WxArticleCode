...
headers = {
    ...
    'cookie': 'sessionid=4m2xs8fbfp4x2xxn204zq4byhph1u691',
}
cookies={
    'sessionid': '4m2xs8fbfp4x2xxn204zq4byhph1u691'
}
# ------------------- 全局 session -------------------
...
def getimg():
    ...
    url='https://www.spiderdemo.cn/captcha/api/cap2_challenge/captcha_image/?t=1760858583186'


    # https://www.spiderdemo.cn/captcha/api/cap2_challenge/captcha_image/?t=1760690058653
    print(url)
